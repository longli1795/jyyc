...
"""
从Excel文件初始化薪酬核算基础数据
读取"薪酬核算基础数据.xlsx"并生成salary_accounting_data.py文件
"""
...
def init_salary_accounting_from_excel():
    """从Excel文件导入数据并生成Python数据文件"""
    try:
        # Excel文件路径
        excel_file = '薪酬核算基础数据.xlsx'
...
if __name__ == '__main__':
    success = init_salary_accounting_from_excel()
